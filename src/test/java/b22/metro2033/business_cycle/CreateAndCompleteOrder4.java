...
public class CreateAndCompleteOrder4 {
    ...
    public void test1_OpenOrdersByHeadCourier() throws Exception{
    ...
    public void test2_OpenFormCreateOrderByHeadCourier() throws Exception{
    ...
    @Test
    @WithMockUser(username = "head_courier", password = "ggg", authorities = "delivery:write")
    public void test3_PostCreateOrderByHeadCourier() throws Exception{
    ...
    public void test4_AlertByCourier() throws Exception{
    ...
    @Test
    @WithMockUser(username = "c", password = "ggg", authorities = "delivery:read")
    public void test5_ShowingOrdersByCourier() throws Exception{
    ...
    @Test
    @WithMockUser(username = "c", password = "ggg", authorities = "delivery:read")
    public void test6_OfShowingOrderByCourier() throws Exception{
        User user = userRepository.findByLogin("c").orElse(null);
        Courier courier = createTestCourier(user);
        DeliveryOrder order = createOrderForCourier(courier, DeliveryState.RECEIVED);
    ...
    @Test
    @WithMockUser(username = "c", password = "ggg", authorities = "delivery:read")
    public void test7_OfChangeStateByCourier() throws Exception{
        User user = userRepository.findByLogin("c").orElse(null);
        Courier courier = createTestCourier(user);
        DeliveryOrder order = createOrderForCourier(courier, DeliveryState.RECEIVED);
    ...
    @Test
    @WithMockUser(username = "c", password = "ggg", authorities = "delivery:read")
    public void test8_OfEndOrderByCourier() throws Exception{
        User user = userRepository.findByLogin("c").orElse(null);
        Courier courier = createTestCourier(user);
    ...
    @Test
    @WithMockUser(username = "head_courier", password = "ggg", authorities = "delivery:read")
    public void test9_OpenOrdersByHeadCourierAfterClosedOrder() throws Exception{
        test8_OfEndOrderByCourier();
        mockMvc.perform(get("/delivery"))
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(status().isOk());
    ...
    //@Sql(value = {"/create-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @WithMockUser(username = "head_courier", password = "ggg", authorities = "delivery:read")
    public void test_ShowingOrderClosedByHeadCourier() throws Exception{
        User user = userRepository.findByLogin("c").orElse(null);
        Courier courier = createTestCourier(user);
